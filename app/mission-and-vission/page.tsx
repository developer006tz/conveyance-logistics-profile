...
function MissionAndVission() {
  return (
    <>
      <PageNavigation currentPath="/mission-and-vission" />
          ...
          <div className="grid grid-cols-2 gap-8 mb-16">
            <div className="bg-white/5 backdrop-blur-sm rounded-lg p-8 shadow-xl">
              ...
              <p className="text-white/90 text-sm leading-relaxed">
                {"To deliver exceptional logistics services and container solutions that enable businesses to succeed in a connected world."}
              </p>
            </div>
            <div className="bg-white/5 backdrop-blur-sm rounded-lg p-8 shadow-xl">
              <div className="flex items-center gap-3 mb-6">
              ...
              <p className="text-white/90 leading-relaxed text-sm text-left">
                {"To be East Africa's leading provider of container solutions and clearing and forwarding services, setting new benchmarks for efficiency, reliability, and customer satisfaction in the logistics industry."}
              </p>
            </div>
          </div>

          {/* Core Values */}
          <div className="bg-white/5 backdrop-blur-sm rounded-lg p-8 shadow-xl mb-16">
