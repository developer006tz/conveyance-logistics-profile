  ...
  const services = [
    {
      ...
      description:
        "Wide range of high-quality containers for purchase, tailored to meet your domestic and storage needs.",
    },
    {
      title: "Container Rental",
      description:
        "Flexible rental options for containers, ideal for short-term storage or transport requirements.",
    },
    {
      title: "Reefer Containers",
      description:
        "Temperature-controlled reefer containers, ensuring the safe transport of perishable goods.",
    },
    {
      title: "Container Customization",
      description:
        "We provide customized container solutions designed for offices, accommodation, and specialized applications.",
    },
  ];

  return (
    <>
      <PageNavigation currentPath="/services-and-solutions" />
        ...
        <div className="relative z-10 flex flex-col h-full p-16 print:p-16">
          ...
          <div className=" mb-4">
            <p className="text-white/90 text-md text-center leading-relaxed mb-6">
              {
                "At Conveyance, we deliver comprehensive container and logistics solutions tailored to your business needs. Our integrated approach combines industry expertise with cutting-edge technology to optimize your supply chain operations."
              }
            </p>
          </div>
