  ...
  const products = [
    {
      ...
      description: "Flat rack container is used for out of gauge and/or heavy cargo. It is a platform (container bottom) of standard size without roof and sidewalls. The end walls are folded to facilitate loading. It is equipped with cargo fastening and handling devices. OUG (OOG)Out Of Gauge cargo dimensions exceed the dimensions of a standardcontainer (are exposes outsidethe container)"
    },
    {
      title: "Open-Top Container",
      image: "/images/open-top-container.jpg",
      description: "An Open Top Container is used for transporting cargo that can only be loaded vertically or exceeds the height of a standard container. It has a removable roof, which can be a tent or a hard cover, and a removable top crossbar over the door. OUG (OOG) Out Of Gauge cargo dimensions exceed the dimensions of a standard container"
    },
  ];

  return (
    <>
      <PageNavigation currentPath="/our-products-2" />
        ...
        <div className="relative z-10 flex flex-col h-full p-16 print:p-16">
          ...
          <div className="space-y-8 mb-16">
            {products.map((product, index) => (
              <div key={index} className="bg-white/5 backdrop-blur-sm rounded-lg pr-4 py-2 pl-2 mb-16 shadow-xl flex gap-8">
                <div className="w-[45%]">
                  <img 
                    src={product.image} 
                    alt={product.title} 
